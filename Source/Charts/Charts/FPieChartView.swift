...
open class FPieChartView: PieRadarChartViewBase
{
    ...
    internal override func initialize()
    {
        ...
        renderer = FPieChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _xAxis = nil
    ...
    @objc open var maxAngle: CGFloat
    {
        ...
        set
        {
            ...
            if _maxAngle > 360.0
            {
                _maxAngle = maxAngle - 360.0
            }
            
            if _maxAngle < 0.0
            {
							_maxAngle = 360.0 + maxAngle
            }
        }
    }
}
