//
//  FPieChartRenderer.swift
//  ChartsDemo-iOS
//
//  Created by Vladimir Shemet on 01.02.2020.
...
open class FPieChartRenderer: DataRenderer
{
    @objc open weak var chart: FPieChartView?

    @objc public init(chart: FPieChartView, animator: Animator, viewPortHandler: ViewPortHandler)
    {
...
//            }
        ...
        // We can do this in drawDataSet, since we know FPieChartView can have only 1 dataSet
    ...
    open override func drawValues(context: CGContext)
    {
        ...
        for i in 0 ..< dataSets.count
        {
            ...
            {
                guard let e = dataSet.entryForIndex(j) else { continue }
								guard e.y > 0 else { xIndex += 1; continue }
    ...
    open override func drawHighlighted(context: CGContext, indices: [Highlight])
    {
        ...
        // NOTE: - This relies on drawDataSet() being called before drawHighlighted in FPieChartView.
